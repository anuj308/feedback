...
const HomeNavbar = ({ onSearch }) => {
  ...
  return (
    <nav className="bg-white border-b border-gray-200 px-4 py-2 sticky top-0 z-40">
          ...
          <form onSubmit={handleSearchSubmit} className="relative">
            <div className="relative">
              ...
              <input
                ...
                className="block w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50 hover:bg-white transition-colors"
              />
            </div>
          </form>
        </div>
